...
import { editStudents,editUser, } from '../../Redux/slices/StudentsSlice';
import { FaRegEdit } from "react-icons/fa";

const EditStudent = ({uuid,name, age,siblings,sex,gpa,class : studentclass}) => {
  ...
  const postData = async (data)=>{
         try{
          if(Object.entries(errors).length==0){
            await dispatch(editStudents(data))
            .then(async(res)=>{
